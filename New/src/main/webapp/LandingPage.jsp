...
<body>
	...
	<script>
		...
		function search() {
			...
			window.location.href = 'SearchServlet?departureCity='
					+ encodeURIComponent(departureCity) + '&destinationCity='
					+ encodeURIComponent(destinationCity) + '&departureDate='
					+ encodeURIComponent(departureDate) + '&returnDate='
					+ encodeURIComponent(returnDate) + '&tripType='
					+ encodeURIComponent(tripType) + '&travelClass='
