...
<div class="Input-Box">
        ...
        <div class="Input">
            <form action="CustomerInformationtDupe.jsp" method="POST">
...
%>
        <div style="color: white;">
            <a href='CustomerInformation.jsp' style = "color: white; 
            text-decoration: none;">Create a Unique Account</a>
            <p></p>
            Back to <a href='../LoginPage/LoginPage.jsp' style = "color: white;
