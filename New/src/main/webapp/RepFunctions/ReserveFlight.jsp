...
<head>
    <meta charset="UTF-8">
    <link href="ReserveFlight.css" rel="stylesheet">
</head>
<body>
    <div class="nav-1">
        <div class="title2">
    ...
    <div class="nav-2">
        ...
        <div class="op2">Reserve Customer's Flight</div>
        <div class="op7">
            <a>Profile</a>
        </div>
    </div>
    ...
    <div class="nav-4">
        <div class="nav-5">
            <div class="nav-6">Enter the required information to reserve a customer's flight.</div>
            <div class="nav-7"></div>
                <form action="ReserveFlightHandler.jsp" method="post">
                	<div style="font-family:freeroad; padding-left: 40px">
                    	<input type="text" name="username" placeholder="Customer's Username">
                	</div>
                	<br>
                	<div style="font-family:freeroad; padding-left: 40px">
